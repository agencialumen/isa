...
const SubscriptionCard = ({ title, price, features, buttonText, model, popular = false }) => {
  return (
    <motion.div
      whileHover={{
        y: -10,
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <button
          className={`w-full py-3 rounded-lg ${popular ? "bg-gradient-to-r from-rose-500 to-red-500 hover:from-rose-600 hover:to-red-600" : "bg-zinc-700 hover:bg-zinc-600"} text-white font-medium transition-all duration-300`}
        >
          {buttonText}
        </button>
      </div>
